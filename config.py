...
def configuration():
    ...
    try:
        ...
        optionlabel = customtkinter.CTkLabel(generaltab, text="Pick an option:", fg_color="transparent")
        ...
        optionmenu = customtkinter.CTkOptionMenu(generaltab, values=["Aimbot", "Triggerbot"], command=optionmenu_callback)
        ...
        configsharelabel = customtkinter.CTkLabel(generaltab, text="Share or import configs:", fg_color="transparent")
        configsharelabel.pack(pady=padding, padx=padding, anchor="w")

        configinput = customtkinter.CTkEntry(master=generaltab, placeholder_text="Enter the config here", width=300)
        ...
        configinputset = customtkinter.CTkButton(master=generaltab, text="Set Config", command=inputconfig)
        ...
        copyconfigbutton = customtkinter.CTkButton(master=generaltab, text="Copy Config", command=copyconfig)
        ...
        sidelabel = customtkinter.CTkLabel(aimtab, text="Pick a block option:", fg_color="transparent")
        ...
        sidemenu = customtkinter.CTkOptionMenu(aimtab, values=["Left (fn)", "Right", "None"], command=sidemenu_callback)
        sidemenu.set("None")
